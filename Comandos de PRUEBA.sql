...
ID_CONTRATO_PARAMETRO IN CONTRATO_EMPRESA.ID_CONTRATO%TYPE,
...
IS
FLAITE EMPRESA.ID_EMPRESA%TYPE;
BEGIN
  ...
  SELECT ID_EMPRESA INTO FLAITE FROM EMPRESA WHERE ID_EMPRESA = ID_EMPRESA_PARAMETRO;
  
  INSERT INTO CONTRATO_EMPRESA VALUES (ID_CONTRATO_PARAMETRO,DESCRIPCION_CONTRATO_PARAMETRO,FECHA_INICIO_PARAMETRO,FLAITE,ESTADO_CONTRATO_PARAMETRO,FECHA_TERMINO_PARAMETRO);
END SP_INSERTAR_EMPRESA;

--LLamando al procedimiento.
exec SP_INSERTAR_EMPRESA(77,'PRUEBA STORE PROCEDURE','DESCRIPCION PRUEBA',2,70046800,1,'\IMG\LOGO4','PRUEBA@PRUEBA.CL','PRUEBA_RAZON_SOCIAL','EJERCITO 215',4,'DESCRIPCION CONTRATO PRUEBA',SYSDATE,1,SYSDATE);
...
DELETE FROM CONTRATO WHERE ID_EMPRESA = 4;  
